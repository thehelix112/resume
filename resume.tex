...
\textwidth=6.2in
\hoffset=0.7in   %make this smaller to get a smaller left margin
...
\begin{list}{}{\leftmargin=0em \topsep=0pt \partopsep=0pt \parsep=2.5pt}
  ...
  %\item Architectural understanding of cloud concepts and systems.
\end{list}
...
\begin{list}{\labelitemi}{\leftmargin=1.5em \topsep=5pt \partopsep=0pt \parsep=2.5pt}
  ...
  %\item Responsible for the core Content Delivery Network (CDN) team, covering core platforms, systems, networking, SRE, traffic management
  \item Lead team developing Web Application Firewall and Layer 7 Anti-DDoS products
  %\item Founding member of the Yahoo Senior Tech Council
  %\item Founding member of Verizon open source committee.  Verizon github owner
\end{list}

%% {\bf Sr Director, Engineering and Chief Architect,} previously Content Delivery Network Architect and Evangelist, Security Core Team Lead.\\
%% Yahoo EdgeCast (formerly Verizon Digital Media Services, EdgeCast), Los Angeles, CA {\em (2012-2022)}
%% %\begin{list}{\labelitemi}{\leftmargin=1em}
%% \begin{list}{\labelitemi}{\leftmargin=1.5em \topsep=5pt \partopsep=0pt \parsep=2.5pt}
%%   \item Lead team developing Web Application Firewall and Layer 7 Anti-DDoS products.
